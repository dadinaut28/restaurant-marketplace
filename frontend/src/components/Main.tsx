...
export function Main() {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-center mt-[20vh] text-3xl leading-8 md:leading-10 md:text-3xl lg:text-5xl lg:leading-14 text-gray-200 sm:mt-0 font-semibold outline-orange-500">
